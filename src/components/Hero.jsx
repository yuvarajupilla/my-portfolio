...
function Hero() {
  ...
  return (
    <section className="hero-section">
      ...
      {/* ── PROFILE IMAGE — always full height right side / mobile full bg ── */}
      <div className="profile-col anim-profile">
        ...
        {/* OTW card - hidden on mobile */}
        <div className="otw-card anim-otw desktop-only">
      ...
      <style>{`
        /* ── PROFESSIONAL RESUME FONTS (Manrope + Inter) ── */
        ...
        .anim-otw     { animation:popIn 0.65s cubic-bezier(0.34,1.56,0.64,1) 1.15s both; }
        ...
        .hero-badge {
          ...
          font-size:12.5px; color:#c4b5fd; font-weight:600; letter-spacing:0.02em;
          margin-bottom:24px; width:fit-content;
          backdrop-filter: blur(4px);
        }

        /* HEADING — Manrope for professional resume feel */
        .hero-heading {
        ...
        .social-label { font-size:11.5px; color:#475569; font-weight:700; border-bottom:2px solid #7c3aed; padding-bottom:2px; white-space:nowrap; letter-spacing:0.04em; text-transform:uppercase; }
        ...
        .tech-title-txt { display:block; font-size:12.5px; font-weight:700; color:#e2e8f0; line-height:1.25; }
        ...
        @media (max-width: 860px) {
          ...
          .hero-desc { font-size:13.5px; max-width:340px; margin-bottom:22px; }
          ...
          .cta-row { gap:10px; margin-bottom:22px; }
          .social-section { gap:14px; }
        ...
        @media (max-width: 480px) {
          .content-col { padding: 100px 18px 18px 18px; }
          .hero-heading { font-size: clamp(1.7rem, 8vw, 2.4rem); }
          .hero-badge { font-size:11.5px; padding:5px 13px; }
          .hero-desc { font-size:13px; }
          .cta-row { flex-direction:column; gap:10px; }
          .btn-primary, .btn-outline { text-align:center; width:100%; }
          .feat-row { flex-direction: row; flex-wrap: wrap; }
          .feat-chip { flex: 1 1 calc(50% - 4px); min-width: unset; }
          .social-section { flex-direction:row; align-items:center; gap:12px; flex-wrap:wrap; }
          .social-label { font-size:10px; }
          .tech-bar { padding:0 14px; height:58px; }
          .tech-strip-wrapper { gap: 24px; }
          .tech-name { font-size:11px; }
          .tech-label-block { gap: 8px; }
